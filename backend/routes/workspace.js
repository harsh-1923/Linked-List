...
const { getAllWorkSpaces, addWorkspace, displayWorkspaces, getWorkspaceByUID } = require("../controllers/workspaceControllers.js");

workspaceRouter.post("/getAllWorkSpaces", getAllWorkSpaces);
workspaceRouter.post("/addWorkspace", addWorkspace);
workspaceRouter.get("/displayWorkspaces", displayWorkspaces);
workspaceRouter.post("/getWorkspaceByUID", getWorkspaceByUID);
...
// router.put("/updateWorkspace/:id", fetchUser, async (req, res) => {
//   try {
//     const { category } = req.body;
//     // create a newWorkspace object
//     const newWorkspace = {};
//     if (category) {
//       newWorkspace.category = category;
//     }
...
//     workspace = await Workspaces.findByIdAndUpdate(
//       req.params.id,
//       { $set: newWorkspace },
//       { new: true }
//     );
...
// router.delete("/deleteWorkspace/:id", fetchUser, async (req, res) => {
//   try {
//     //Find the workspace by id
//     let workspace = await Workspaces.findById(req.params.id);
//     // if no workspace with that id exists
